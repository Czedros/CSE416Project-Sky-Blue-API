const seedPlayers = [
  ...
  // AL Pitchers
  { playerId: 543037, name: "Gerrit Cole", position: ["P"], team: "NYY", mlbTeamId: 147, league: "AL", isPitcher: true, status: "active", stats: { ERA: 2.63, W: 15, SV: 0, K: 222, IP: 209.0 } },
  { playerId: 661403, name: "Emmanuel Clase", position: ["P"], team: "CLE", mlbTeamId: 114, league: "AL", isPitcher: true, status: "active", stats: { ERA: 0.61, W: 4, SV: 44, K: 66, IP: 74.1 } },
  { playerId: 623352, name: "Josh Hader", position: ["P"], team: "HOU", mlbTeamId: 117, league: "AL", isPitcher: true, status: "active", stats: { ERA: 1.28, W: 8, SV: 33, K: 71, IP: 56.1 } },
  { playerId: 663556, name: "Tarik Skubal", position: ["P"], team: "DET", mlbTeamId: 116, league: "AL", isPitcher: true, status: "active", stats: { ERA: 2.39, W: 18, SV: 0, K: 228, IP: 192.0 } },
  { playerId: 656302, name: "Seth Lugo", position: ["P"], team: "KC", mlbTeamId: 118, league: "AL", isPitcher: true, status: "active", stats: { ERA: 3.00, W: 16, SV: 0, K: 185, IP: 206.2 } },

  // NL Pitchers
  { playerId: 669203, name: "Corbin Burnes", position: ["P"], team: "ARI", mlbTeamId: 109, league: "NL", isPitcher: true, status: "active", stats: { ERA: 2.92, W: 15, SV: 0, K: 181, IP: 194.1 } },
  { playerId: 675911, name: "Spencer Strider", position: ["P"], team: "ATL", mlbTeamId: 144, league: "NL", isPitcher: true, status: "injured", injuryStatus: "Elbow - UCL", stats: { ERA: 3.86, W: 20, SV: 0, K: 281, IP: 186.2 } },
  { playerId: 571945, name: "Zack Wheeler", position: ["P"], team: "PHI", mlbTeamId: 143, league: "NL", isPitcher: true, status: "active", stats: { ERA: 2.57, W: 16, SV: 0, K: 224, IP: 200.0 } },
  { playerId: 656427, name: "Chris Sale", position: ["P"], team: "ATL", mlbTeamId: 144, league: "NL", isPitcher: true, status: "active", stats: { ERA: 2.38, W: 18, SV: 0, K: 225, IP: 177.2 } },
  { playerId: 682847, name: "Paul Skenes", position: ["P"], team: "PIT", mlbTeamId: 134, league: "NL", isPitcher: true, status: "active", stats: { ERA: 1.96, W: 11, SV: 0, K: 170, IP: 133.0 } },
];
